...
- `precomputed-catalogs.json` — deploy-time research catalogs for top tourist cities, generated by `build-precomputed-catalogs.mjs` during the Pages workflow (optional in local/file use)
